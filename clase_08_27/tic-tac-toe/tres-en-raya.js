...
function TresEnRaya(casilla) {
    ...
    if (alguienGano()) {
        mostrarMensaje("Gana " + jugadorActual);
        juegoTerminado = true;
        return;
    }
    if (hayEmpate()) {
...
function alguienGano() {
    ...
    return (sonIguales(casillas[0], casillas[1], casillas[2]) ||
...
function sonIguales(casilla1, casilla2, casilla3) {
    return (casilla1.textContent !== "" &&
